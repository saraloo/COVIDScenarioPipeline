...
```{r finalerrorsim, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Final statistic (bias or mae) of the simualated trajectories rate. Boxplots show the distribution of values across geoids."}
...
```{r speedsim, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="Mean number of iterations to readh the  final statistic (bias or mae) of the simualated trajectories rate. Boxplots show the distribution of values across geoids."}
...
```
```{r speedhpar, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 10, fig.height = 10, fig.cap="Final statistic (bias or mae) of the confirmation rate. Boxplots show the distribution of values across geoids."}
...
```{r speed, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 10, fig.height = 10, fig.cap="Number of iterations to be withing 10% of the final statistic (bias or mae) of the confirmation rate. Boxplots show the distribution of values across geoids."}
